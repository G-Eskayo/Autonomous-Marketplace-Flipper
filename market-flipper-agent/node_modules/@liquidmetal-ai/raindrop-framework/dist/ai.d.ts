...
export declare const MODEL_CATALOG: readonly [{
    ...
    readonly capability: "chat";
    readonly provider: "external";
    readonly providerModel: "llama-3.1-70b-instruct";
    readonly description: "External model routed through model-router: llama-3.1-70b-instruct";
}, {
