...
export const MODEL_CATALOG = [
  ...
  },
  {
    ...
    capability: 'chat',
    provider: 'external',
    providerModel: 'llama-3.1-70b-instruct',
    description: 'External model routed through model-router: llama-3.1-70b-instruct'
  },
  {
    name: 'deepseek-r1',
    capability: 'chat',
...
type gpt_oss_120b_Input = AiInput41;
type llama_3_1_8b_instant_Input = AiInput42;
type gemma_9b_it_Input = AiInput43;
type kimi_k2_Input = AiInput44;
type gpt_oss_20b_Input = AiInput45;
type bge_embeddings_Input = AiInput46;
type piiranha_pii_Input = AiInput47;
...
export type AiModelInputMap = {
  [K in AvailableModel]: 
    ...
    K extends 'bge-m3' | 'bge-small-en-v1.5' | 'bge-base-en-v1.5' | 'embeddinggemma-300m' | 'bge-large-en-v1.5' | 'embeddings' ? ({ input: string | string[]; model?: string; encoding_format?: 'float' | 'base64'; dimensions?: number } | { prompt: string }) :
    ...
    K extends 'llama-3.3-70b' | 'llama-3.1-8b-external' | 'llama-3.1-70b-instruct' | 'deepseek-r1' | 'deepseek-v3-0324' | 'deepseek-r1-distill-llama-70b' | 'qwen-3-32b' | 'llama-3.3-swallow-70b' | 'gpt-oss-120b' | 'llama-3.1-8b-instant' | 'gemma-9b-it' | 'kimi-k2' | 'gpt-oss-20b' ? OpenAIChatInputExternal :
    OpenAIChatInput;
};
...
export type AiModelOutputMap = {
  [K in AvailableModel]: 
    ...
    K extends 'bge-m3' | 'bge-small-en-v1.5' | 'bge-base-en-v1.5' | 'embeddinggemma-300m' | 'bge-large-en-v1.5' | 'embeddings' ? (OpenAIEmbeddingOutput & { embeddings?: Array<{ embedding: number[] }> }) :
